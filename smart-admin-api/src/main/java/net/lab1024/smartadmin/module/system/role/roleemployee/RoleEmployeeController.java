 ...
 */
@Api(tags = {SwaggerTagConst.Club.MANAGER_ROLE_USER})
@OperateLog
@RestController
public class RoleEmployeeController {
    ...
    @ApiOperation(value = "获取角色成员-用户列表", notes = "获取角色成员-用户列表（分页）")
    ...
    @ApiOperation(value = "从角色成员列表中移除用户", notes = "从角色成员列表中移除用户")
    ...
    @ApiOperation(value = "从角色成员列表中批量移除用户", notes = "从角色成员列表中批量移除用户")
    ...
    @ApiOperation(value = "角色成员列表中批量添加用户", notes = "角色成员列表中批量添加用户")
    ...
    @ApiOperation(value = "通过用户id获取所有角色以及用户具有的角色", notes = "通过员工id获取所有角色以及用户具有的角色")
    @GetMapping("/role/getRoles/{employeeId}")
    @ApiImplicitParams({@ApiImplicitParam(name = "employeeId", value = "用户id", paramType = "path", required = true)})
